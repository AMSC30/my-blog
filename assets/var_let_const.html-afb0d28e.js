import{_ as n,p as s,q as a,Y as e}from"./framework-e1bed10d.js";const c={},o=e(`<h1 id="面试官-说说var、let、const之间的区别" tabindex="-1"><a class="header-anchor" href="#面试官-说说var、let、const之间的区别" aria-hidden="true">#</a> 面试官：说说var、let、const之间的区别</h1><p><img src="https://static.vue-js.com/d2aba2e0-50f7-11eb-85f6-6fac77c0c9b3.png" alt=""></p><h2 id="一、var" tabindex="-1"><a class="header-anchor" href="#一、var" aria-hidden="true">#</a> 一、var</h2><p>在ES5中，顶层对象的属性和全局变量是等价的，用<code>var</code>声明的变量既是全局变量，也是顶层变量</p><p>注意：顶层对象，在浏览器环境指的是<code>window</code>对象，在 <code>Node</code> 指的是<code>global</code>对象</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token number">10</span><span class="token punctuation">;</span>
