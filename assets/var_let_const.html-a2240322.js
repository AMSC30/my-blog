import{_ as a,p as e,q as c,s as n,R as o,t as p,Y as t,n as l}from"./framework-e1bed10d.js";const i={},d=t(`<h1 id="var、let、const的区别" tabindex="-1"><a class="header-anchor" href="#var、let、const的区别" aria-hidden="true">#</a> var、let、const的区别</h1><h2 id="一、var" tabindex="-1"><a class="header-anchor" href="#一、var" aria-hidden="true">#</a> 一、var</h2><p>使用<code>var</code>声明的变量存在变量提升的情况</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>a<span class="token punctuation">)</span> <span class="token comment">// undefined</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其它情况，<code>const</code>与<code>let</code>一致</p><h2 id="四、区别" tabindex="-1"><a class="header-anchor" href="#四、区别" aria-hidden="true">#</a> 四、区别</h2><p><code>var</code>、<code>let</code>、<code>const</code>三者区别可以围绕下面五点展开：</p><ul><li>变量记录方式不同导致变量提升和暂时性死区</li><li>块级作用域</li><li>重复声明</li><li>修改声明的变量</li><li>使用</li></ul><h3 id="变量记录" tabindex="-1"><a class="header-anchor" href="#变量记录" aria-hidden="true">#</a> 变量记录</h3><p>创建执行上下文的时候，会通过词法环境和变量环境对变量和外部环境进行记录，对于var生命的变量，会记录在变量环境中，同时初始化为undefined，导致了变量提升；对于let和const声明的变量记录在词法环境中，并记录为未初始化（unInitialize），等到代码执行到变量声明的位置的时候，才进行赋值，导致了暂时性死区</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// var</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="块级作用域" tabindex="-1"><a class="header-anchor" href="#块级作用域" aria-hidden="true">#</a> 块级作用域</h3><p><code>var</code>不存在块级作用域，<code>let</code>和<code>const</code>存在块级作用域，无法在块作用域外部对变量进行访问</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// var</span>
<span class="token punctuation">{</span>
    <span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token number">20</span>
<span class="token punctuation">}</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>a<span class="token punctuation">)</span>  <span class="token comment">// 20</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="重复声明" tabindex="-1"><a class="header-anchor" href="#重复声明" aria-hidden="true">#</a> 重复声明</h3><p><code>var</code>允许重复声明变量，<code>let</code>和<code>const</code>在同一作用域不允许重复声明变量</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// var</span>
<span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token number">10</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用" tabindex="-1"><a class="header-anchor" href="#使用" aria-hidden="true">#</a> 使用</h3><p>能用<code>const</code>的情况尽量使用<code>const</code>，其他情况下大多数使用<code>let</code>，避免使用<code>var</code></p><h2 id="参考文献" tabindex="-1"><a class="header-anchor" href="#参考文献" aria-hidden="true">#</a> 参考文献</h2>`,54),r={href:"https://es6.ruanyifeng.com/",target:"_blank",rel:"noopener noreferrer"};function u(v,k){const s=l("ExternalLinkIcon");return e(),c("div",null,[d,n("ul",null,[n("li",null,[n("a",r,[o("https://es6.ruanyifeng.com/"),p(s)])])])])}const b=a(i,[["render",u],["__file","var_let_const.html.vue"]]);export{b as default};
